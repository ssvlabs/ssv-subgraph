...
export class Operator extends Entity {
  ...
  get totalWithdrawnSSV(): BigInt {
    let value = this.get("totalWithdrawnSSV");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set totalWithdrawnSSV(value: BigInt) {
    this.set("totalWithdrawnSSV", Value.fromBigInt(value));
  }
...
export class DAOValues extends Entity {
  ...
  get effectiveBalanceETH(): BigInt {
    let value = this.get("effectiveBalanceETH");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set effectiveBalanceETH(value: BigInt) {
    this.set("effectiveBalanceETH", Value.fromBigInt(value));
  }
...
export class OperatorWithdrawnSSV extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save OperatorWithdrawnSSV entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type OperatorWithdrawnSSV must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("OperatorWithdrawnSSV", id.toString(), this);
    }
  }

  static loadInBlock(id: string): OperatorWithdrawnSSV | null {
    return changetype<OperatorWithdrawnSSV | null>(
      store.get_in_block("OperatorWithdrawnSSV", id),
    );
  }

  static load(id: string): OperatorWithdrawnSSV | null {
    return changetype<OperatorWithdrawnSSV | null>(
      store.get("OperatorWithdrawnSSV", id),
    );
  }
...
export class ValidatorExited extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save ValidatorExited entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type ValidatorExited must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("ValidatorExited", id.toString(), this);
    }
  }

  static loadInBlock(id: string): ValidatorExited | null {
    return changetype<ValidatorExited | null>(
      store.get_in_block("ValidatorExited", id),
    );
  }

  static load(id: string): ValidatorExited | null {
    return changetype<ValidatorExited | null>(store.get("ValidatorExited", id));
  }
